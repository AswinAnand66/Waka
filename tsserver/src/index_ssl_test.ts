...
var key = fs.readFileSync('/sslcerts/qa_wakatech_com.key');
var cert = fs.readFileSync( '/sslcerts/qa_wakatech_com.crt' );
var ca = fs.readFileSync( '/sslcerts/qa_wakatech_com.ca-bundle' );
...
var httpsPort=443;
var https = require('https');
https.createServer(options, app).listen(httpsPort, "0.0.0.0", () => console.log('WAKA Server listening on port '+httpsPort+'!'));
